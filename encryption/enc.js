ProtectPANandCVV = function(e, t, r) {
    ...
    if (1 == r) {
        var u = n.luhn(a);
        var s = a.substring(PIE.L + 1, a.length - PIE.E);
        var d = o.encrypt(s + i, c, PIE.K, 10);
        var l = a.substr(0, PIE.L) + "0" + d.substr(0, d.length - i.length) + a.substring(a.length - PIE.E);
        var f = n.reformat(n.fixluhn(l, PIE.L, u), e);
        var p = n.reformat(d.substring(d.length - i.length), t);
...
fixluhn = function(e, t, r) {
    ...
    if(0 != a) {
        ...
        return e.substr(0, t) + a + e.substr(t + 1)
    }else {
        return e
    }
}
...
compute = function(e, t) {
        ...
        return 0 != o && 0 == (15 & o) || (a = r[0], leftShift(r), MSBnotZero(a) && (r[3] ^= const_Rb), n[o >> 2 & 3] ^= 128 << 8 * (3 - (3 & o))),
            n[0] ^= r[0],
            n[1] ^= r[1],
            n[2] ^= r[2],
            n[3] ^= r[3],
